# Create the main HTML file for the e-commerce project
html_content = '''<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>CloudTech Store - E-commerce Platform</title>
            ...
            <div class="header-content">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        ...
                        <li><a href="#" onclick="filterProducts('sports')">Sports</a></li>
                    </ul>
                </nav>
    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <h2>Welcome to CloudTech Store</h2>
                <p>Discover amazing products with secure cloud-based shopping experience</p>
                <button class="cta-btn" onclick="document.getElementById('products').scrollIntoView()">Shop Now</button>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h4>CloudTech Store</h4>
                    <p>Your trusted e-commerce platform for quality products and secure transactions.</p>
                </div>
                <div class="footer-section">
                    <h4>Quick Links</h4>
                    <ul>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 CloudTech Store. All rights reserved.</p>
            </div>
        </div>
    </footer>
